import { Add, CallSplit, Remove } from "@material-ui/icons"
    ...
    return (
        <Container>
            ...
            <Wrapper>
                ...
                <InfoContainer>
                    <Title>{product.title}dsasdas</Title>
                    <Desc> {product.desc}</Desc>
                    <Price>R$ {product.price}</Price>
                    <FilterContainer>
                        <Filter>
                            <FilterTitle>Cor</FilterTitle>
                            {product.color?.map((color) => (<FilterColor color={color} key={color} onClick={(c) => setColor(c)} />))}
                        </Filter>
                        <Filter>
